  ...
  try{
    ...
    //Handle signup error
     ...
     if(error.response && error.response.data && error.response.data.message){
      ...
      setError("An unexpeceted error occurred. Please try again")
     }
    }
}
    ...
    <div className='flex items-center justify-center mt-28'>
      <div className='w-96 border border-slate-400 rounded px-7 py-10 bg-white '>
        <form onSubmit={handleSignup}>
          ...
          <input type="text" name="" id="" placeholder='Name' className='input-box' value={name} onChange={(e)=>setName(e.target.value)} />
